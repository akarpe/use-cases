...
public class DEIMServiceImpl implements DEIMService {
	...
	public Response addPerson(Person person) {
		...
		System.out.println("\n\n\nCAmel ......" + person.getLocalid());
		try {
			String requestBodyAndHeaders = template.requestBodyAndHeaders(
					template.getDefaultEndpoint(), person, headers,
					String.class);
			System.out.println(requestBodyAndHeaders + " Response");
